...
<body class="bg-white text-gray-800">
    ...
    <div class="container mx-auto px-4 mt-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" id="productos">
            ...
            <!-- 🔽 Productos publicados dinámicamente desde base de datos -->
            <% if (productos != null && !productos.isEmpty()) {
                for (Producto p : productos) {
                    if (p.getCategoria().equalsIgnoreCase("pantalon")) { %>
                        <div class="producto bg-white border rounded-lg shadow hover:shadow-md transition p-4" data-categoria="pantalones">
                            <img src="<%= request.getContextPath() %>/imagen/<%= p.getImagen() %>" alt="<%= p.getNombre() %>" class="w-full h-70 object-cover rounded-md mb-3">
            ...
            <%      }
                ...
                <p class="text-center text-gray-500 col-span-full">No hay pantalones publicados aún.</p>
            <% } %>
