    ...
    <body class="bg-white text-gray-800">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" id="productos">
            ...
            <div class="producto bg-white border rounded-lg shadow hover:shadow-md transition p-4" data-categoria="pantalones">
                ...
                <h2 class="text-lg font-semibold text-gray-800">Pantalón Niña Azul</h2>
                <p class="text-pink-600 font-bold text-sm mb-2">S/ 39.90</p>
                <div class="flex justify-between mt-3">
                    <button class="bg-orange-500 text-white px-3 py-1 rounded-full hover:bg-orange-600 text-sm">Agregar al carrito</button>
                    <button class="bg-pink-500 text-white px-3 py-1 rounded-full hover:bg-pink-600 text-sm">Ver detalle</button>
                </div>
            </div>
            ...
            <div class="producto bg-white border rounded-lg shadow hover:shadow-md transition p-4" data-categoria="polos">
                ...
                <h2 class="text-lg font-semibold text-gray-800">Polo Rosado</h2>
                <p class="text-pink-600 font-bold text-sm mb-2">S/ 24.90</p>
                <div class="flex justify-between mt-3">
                    <button class="bg-orange-500 text-white px-3 py-1 rounded-full hover:bg-orange-600 text-sm">Agregar al carrito</button>
                    <button class="bg-pink-500 text-white px-3 py-1 rounded-full hover:bg-pink-600 text-sm">Ver detalle</button>
                </div>
