...
<html>
    ...
    <body>
        ...
        <%            String error = request.getParameter("error");
            ...
            if (error != null) {
        %>
        <div style="background-color: #f8d7da; color: #842029; padding: 10px; border-radius: 5px; margin: 15px 0;">
            <strong>Error:</strong> <%= detalle != null ? detalle : "Ocurrió un problema al guardar la venta."%>
        </div>
        <%
            }
        %>
        ...
        <div id="mainContent" class="container ml-64 mt-24 p-6">
            <div class="bg-white shadow-xl rounded-3xl">
                ...
                <!-- Contenido -->
                <form id="formVenta" method="POST" action="${pageContext.request.contextPath}/GuardarVenta">
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="tipoPago" name="tipoPago" class="form-select form-select-sm rounded-pill">
                            ...
                            <div>
                                ...
                                <input type="number" id="descuentoVenta" name="descuento" min="0" value="0" class="form-control form-control-sm rounded-pill">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                                ...
                                <div>
                                    <button  type="button" class="btn btn-success w-100 rounded-pill" onclick="agregarProducto()">
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            <button type="button" class="btn btn-secondary rounded-pill" onclick="cerrarFormulario()">
                                <i class="bi bi-x-circle"></i> Cancelar
                            </button>
                            <button type="button" class="btn btn-success rounded-pill" onclick="guardarVenta()">
